...
class OtherTournaments extends StatelessWidget {
  final clubId;
  OtherTournaments({Key? key,this.clubId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: colRef.where("Club Id",isNotEqualTo: clubId).snapshots(),
        builder: (_,snap){
                  ...
                  return InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (_)=>
                          Details(data: snap.data!.docs[index],type:'other',clubId: clubId,)));
                    },
                    child: Padding(
